...
call %RSYNC_CMD% %OSSIM_DATA_REPOSITORY_CYGDRIVE%/test/data/public %OSSIM_DATA_CYGDRIVE%/data
rem if ERRORLEVEL 1 exit 1

call %RSYNC_CMD% %OSSIM_DATA_REPOSITORY_CYGDRIVE%/test/data/geoeye1 %OSSIM_DATA_CYGDRIVE%/data
rem if ERRORLEVEL 1 exit 1

call %RSYNC_CMD% %OSSIM_DATA_REPOSITORY_CYGDRIVE%/test/data/rbt %OSSIM_DATA_CYGDRIVE%/data
rem if ERRORLEVEL 1 exit 1
