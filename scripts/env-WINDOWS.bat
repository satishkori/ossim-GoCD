...
set OSSIM_DEPENDENCIES=%OSSIM_DEV_HOME%\ossim-deps-%OSSIM_DEPENDENCY_VERSION%

set GEOS_DIR=%OSSIM_DEPENDENCIES%
set GEOTIFF_DIR=%OSSIM_DEPENDENCIES%
set TIFF_DIR=%OSSIM_DEPENDENCIES%
