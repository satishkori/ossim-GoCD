...
set GDAL_DIR=%OSSIM_DEPENDENCIES%
set OPENTHREADS_DIR=%OSSIM_DEPENDENCIES%
set KAKADU_AUX_LIBRARY=%OSSIM_DEPENDENCIES%/kakadu/lib/kdu_a75R.lib
set KAKADU_LIBRARY=%OSSIM_DEPENDENCIES%/kakadu/lib/kdu_v75R.lib
set KAKADU_ROOT_SRC=%OSSIM_DEPENDENCIES%/kakadu
set MRSID_DIR=%OSSIM_DEPENDENCIES%/mrsid

set KAKADU_AUX_LIBRARY=%KAKADU_AUX_LIBRARY:\=/%
set KAKADU_LIBRARY=%KAKADU_LIBRARY:\=/%
set KAKADU_ROOT_SRC=%KAKADU_ROOT_SRC:\=/%
set GDAL_DIR=%GDAL_DIR:\=/%
set OPENTHREADS_DIR=%OPENTHREADS_DIR:\=/%
set GEOTIFF_DIR=%GEOTIFF_DIR:\=/%
set GEOS_DIR=%GEOS_DIR:\=/%
